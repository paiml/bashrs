...
**Version**: 12.51.0
**Status**: FULL 36-LAYER Qwen3-4B TRAINING on AMD W5700X via WGPU — 47s/step, 3 steps verified. NF4 dequant→RMSNorm→FFN→loss→backward→AdamW. First 4B model trained on non-NVIDIA GPU.
