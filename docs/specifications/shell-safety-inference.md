...
**Version**: 12.19.0
**Status**: RETRAIN READY. entrenar#270 FIXED (RoPE+QK-norm wired into CUDA forward). Data ready: conversations_v4.jsonl (22K ChatML). Config ready: v2.yaml. Next: preflight gate→Run 8.
