...
impl CorpusRegistry {
    ...
    fn load_expansion5_bash(&mut self) {
        let entries = vec![
            CorpusEntry::new("B-171", "countdown-timer", "Simple countdown loop", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn main() { let mut t = 10; while t > 0 { echo(&format!("{}", t)); t -= 1; } echo("done"); } fn echo(s: &str) {}"#, "echo"),
            CorpusEntry::new("B-172", "string-repeat", "Repeat string N times", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn main() { let n = 5; let mut i = 0; while i < n { echo("ha"); i += 1; } } fn echo(s: &str) {}"#, "echo"),
            CorpusEntry::new("B-173", "sum-range", "Sum integers from 1 to N", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn main() { let n = 100; let mut sum = 0; let mut i = 1; while i <= n { sum += i; i += 1; } }"#, "sum="),
            CorpusEntry::new("B-174", "power-compute", "Integer exponentiation", CorpusFormat::Bash, CorpusTier::Production,
                r#"fn power(base: u32, exp: u32) -> u32 { let mut result = 1; let mut i = 0; while i < exp { result *= base; i += 1; } result } fn main() { let p = power(2, 10); }"#, "power()"),
            CorpusEntry::new("B-175", "abs-value", "Absolute value function", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn abs_val(x: i32) -> i32 { if x < 0 { 0 - x } else { x } } fn main() { let a = abs_val(-42); }"#, "abs_val()"),
            CorpusEntry::new("B-176", "clamp-value", "Clamp value to range", CorpusFormat::Bash, CorpusTier::Production,
                r#"fn clamp(val: i32, lo: i32, hi: i32) -> i32 { if val < lo { lo } else if val > hi { hi } else { val } } fn main() { let c = clamp(150, 0, 100); }"#, "clamp()"),
            CorpusEntry::new("B-177", "sign-function", "Return sign of integer", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn sign(x: i32) -> i32 { if x > 0 { 1 } else if x < 0 { 0 - 1 } else { 0 } } fn main() { let s = sign(-7); }"#, "sign()"),
            CorpusEntry::new("B-178", "is-even-odd", "Even/odd check functions", CorpusFormat::Bash, CorpusTier::Trivial,
                r#"fn is_even(n: u32) -> bool { n % 2 == 0 } fn is_odd(n: u32) -> bool { n % 2 != 0 } fn main() { let e = is_even(42); let o = is_odd(7); }"#, "is_even()"),
            CorpusEntry::new("B-179", "triple-nested-if", "Three-level nested conditionals", CorpusFormat::Bash, CorpusTier::Complex,
                r#"fn main() { let x = 5; let y = 10; let z = 15; if x > 0 { if y > 5 { if z > 10 { echo("deep"); } } } } fn echo(s: &str) {}"#, "echo"),
            CorpusEntry::new("B-180", "variable-swap", "Swap two variables", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn main() { let a = 10; let b = 20; let tmp = a; let a = b; let b = tmp; }"#, "tmp="),
            CorpusEntry::new("B-181", "min-of-three", "Minimum of three values", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn min3(a: i32, b: i32, c: i32) -> i32 { if a <= b && a <= c { a } else if b <= c { b } else { c } } fn main() { let m = min3(5, 3, 7); }"#, "min3()"),
            CorpusEntry::new("B-182", "max-of-three", "Maximum of three values", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn max3(a: i32, b: i32, c: i32) -> i32 { if a >= b && a >= c { a } else if b >= c { b } else { c } } fn main() { let m = max3(5, 3, 7); }"#, "max3()"),
            CorpusEntry::new("B-183", "collatz-step", "Single Collatz step", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn collatz(n: u32) -> u32 { if n % 2 == 0 { n / 2 } else { n * 3 + 1 } } fn main() { let c = collatz(7); }"#, "collatz()"),
            CorpusEntry::new("B-184", "digital-root-step", "Single digital root step", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn main() { let mut n = 942; let mut root = 0; while n > 0 { root += n % 10; n = n / 10; } }"#, "root="),
            CorpusEntry::new("B-185", "triangular-number", "Triangular number computation", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn triangular(n: u32) -> u32 { n * (n + 1) / 2 } fn main() { let t = triangular(10); }"#, "triangular()"),
            CorpusEntry::new("B-186", "multi-return", "Multiple function calls assigned", CorpusFormat::Bash, CorpusTier::Production,
                r#"fn double(x: u32) -> u32 { x * 2 } fn triple(x: u32) -> u32 { x * 3 } fn main() { let a = double(5); let b = triple(5); let c = double(b); }"#, "double()"),
            CorpusEntry::new("B-187", "nested-while", "Nested while loops", CorpusFormat::Bash, CorpusTier::Complex,
                r#"fn main() { let mut i = 0; while i < 3 { let mut j = 0; while j < 3 { j += 1; } i += 1; } }"#, "while"),
            CorpusEntry::new("B-188", "boolean-chain", "Chained boolean logic", CorpusFormat::Bash, CorpusTier::Production,
                r#"fn main() { let a = true; let b = false; let c = true; let result = a && (b || c) && !b; }"#, "result="),
            CorpusEntry::new("B-189", "prefix-suffix", "String prefix and suffix variables", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn main() { let prefix = "pre"; let suffix = "suf"; let base = "fix"; }"#, "prefix="),
            CorpusEntry::new("B-190", "multi-assign-chain", "Chain of dependent assignments", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn main() { let a = 1; let b = a + 1; let c = b + 1; let d = c + 1; let e = d + 1; }"#, "e="),
            CorpusEntry::new("B-191", "modular-arithmetic", "Modular arithmetic expressions", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn main() { let x = 17; let m = 5; let r = x % m; let q = x / m; }"#, "r="),
            CorpusEntry::new("B-192", "comparison-chain", "Multiple comparison operators", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn main() { let x = 10; let lt = x < 20; let gt = x > 5; let eq = x == 10; let ne = x != 0; }"#, "lt="),
            CorpusEntry::new("B-193", "empty-function", "Function with no body logic", CorpusFormat::Bash, CorpusTier::Trivial,
                r#"fn noop() {} fn main() { noop(); }"#, "noop"),
            CorpusEntry::new("B-194", "identity-function", "Identity function", CorpusFormat::Bash, CorpusTier::Trivial,
                r#"fn identity(x: u32) -> u32 { x } fn main() { let v = identity(42); }"#, "identity()"),
            CorpusEntry::new("B-195", "const-propagation", "Constants computed at compile time", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn main() { let width = 80; let height = 24; let area = width * height; let perimeter = 2 * (width + height); }"#, "area="),
            CorpusEntry::new("B-196", "decrement-loop", "Decrement-based loop", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn main() { let mut n = 10; while n > 0 { n -= 1; } }"#, "while"),
            CorpusEntry::new("B-197", "divisor-check", "Check if divisible", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn divides(n: u32, d: u32) -> bool { n % d == 0 } fn main() { let d = divides(42, 7); }"#, "divides()"),
            CorpusEntry::new("B-198", "safe-subtract", "Saturating subtraction", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn safe_sub(a: u32, b: u32) -> u32 { if a > b { a - b } else { 0 } } fn main() { let r = safe_sub(3, 10); }"#, "safe_sub()"),
            CorpusEntry::new("B-199", "flag-variables", "Multiple boolean flags", CorpusFormat::Bash, CorpusTier::Standard,
                r#"fn main() { let verbose = true; let quiet = false; let force = true; let dry_run = false; if verbose && !quiet { echo("info"); } } fn echo(s: &str) {}"#, "verbose="),
            CorpusEntry::new("B-200", "milestone-200", "200th Bash entry - combined patterns", CorpusFormat::Bash, CorpusTier::Production,
                r#"fn compute(a: u32, b: u32) -> u32 { if a > b { a - b } else { b - a } } fn main() { let x = compute(42, 17); let y = compute(x, 10); if y > 0 { echo("positive"); } } fn echo(s: &str) {}"#, "compute()"),
        ];
        self.entries.extend(entries);
    }
    ...
    fn load_expansion5_makefile(&mut self) {
        let entries = vec![
            CorpusEntry::new("M-081", "crystal-build", "Crystal language project", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-082", "elixir-mix", "Elixir/Mix project", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: deps"),
            CorpusEntry::new("M-083", "julia-project", "Julia language project", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: run"),
            CorpusEntry::new("M-084", "r-package", "R package build", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: check"),
            CorpusEntry::new("M-085", "swift-package", "Swift Package Manager build", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-086", "kotlin-gradle", "Kotlin with Gradle wrapper", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-087", "dart-pub", "Dart/Flutter project", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: deps"),
            CorpusEntry::new("M-088", "ocaml-dune", "OCaml with Dune", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-089", "perl-build", "Perl module build", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: test"),
            CorpusEntry::new("M-090", "php-composer", "PHP Composer project", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: install"),
            CorpusEntry::new("M-091", "lua-busted", "Lua with Busted test framework", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: test"),
            CorpusEntry::new("M-092", "cmake-project", "CMake build system", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: configure"),
            CorpusEntry::new("M-093", "meson-project", "Meson build system", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: setup"),
            CorpusEntry::new("M-094", "terraform-infra", "Terraform infrastructure", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: init"),
            CorpusEntry::new("M-095", "ansible-playbook", "Ansible automation", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: deploy"),
            CorpusEntry::new("M-096", "helm-chart", "Kubernetes Helm chart", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: lint"),
            CorpusEntry::new("M-097", "proto-grpc", "Protobuf/gRPC code generation", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: proto"),
            CorpusEntry::new("M-098", "wasm-pack", "WebAssembly with wasm-pack", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-099", "deno-project", "Deno runtime project", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: run"),
            CorpusEntry::new("M-100", "milestone-100-make", "100th Makefile entry - multi-tool", CorpusFormat::Makefile, CorpusTier::Production,
    ...
    fn load_expansion5_dockerfile(&mut self) {
        let entries = vec![
            CorpusEntry::new("D-081", "crystal-app", "Crystal language app", CorpusFormat::Dockerfile, CorpusTier::Production,
            ...
            CorpusEntry::new("D-082", "elixir-phoenix", "Elixir Phoenix web app", CorpusFormat::Dockerfile, CorpusTier::Production,
                ...
                "FROM elixir:1.16-alpine AS builder"),
            CorpusEntry::new("D-083", "julia-app", "Julia application container", CorpusFormat::Dockerfile, CorpusTier::Standard,
                ...
                "FROM julia:1.10"),
            CorpusEntry::new("D-084", "r-shiny", "R Shiny application", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-085", "swift-vapor", "Swift Vapor web framework", CorpusFormat::Dockerfile, CorpusTier::Production,
            ...
            CorpusEntry::new("D-086", "php-laravel", "PHP Laravel application", CorpusFormat::Dockerfile, CorpusTier::Production,
                ...
                "FROM php:8.3-fpm-alpine"),
            CorpusEntry::new("D-087", "ruby-rails", "Ruby on Rails application", CorpusFormat::Dockerfile, CorpusTier::Production,
                ...
                "FROM ruby:3.3-slim"),
            CorpusEntry::new("D-088", "dotnet-api", ".NET Web API", CorpusFormat::Dockerfile, CorpusTier::Production,
                ...
                "FROM mcr.microsoft.com/dotnet/sdk:8.0 AS builder"),
            CorpusEntry::new("D-089", "lua-openresty", "OpenResty Lua web server", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-090", "kotlin-ktor", "Kotlin Ktor server", CorpusFormat::Dockerfile, CorpusTier::Production,
            ...
            CorpusEntry::new("D-091", "perl-mojolicious", "Perl Mojolicious web app", CorpusFormat::Dockerfile, CorpusTier::Standard,
                ...
                "FROM perl:5.38"),
            CorpusEntry::new("D-092", "dart-shelf", "Dart Shelf server", CorpusFormat::Dockerfile, CorpusTier::Production,
            ...
            CorpusEntry::new("D-093", "ocaml-opam", "OCaml with opam", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-094", "clojure-lein", "Clojure with Leiningen", CorpusFormat::Dockerfile, CorpusTier::Production,
            ...
            CorpusEntry::new("D-095", "haskell-stack", "Haskell Stack build", CorpusFormat::Dockerfile, CorpusTier::Production,
            ...
            CorpusEntry::new("D-096", "nim-app", "Nim language application", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-097", "zig-app", "Zig language application", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-098", "gleam-beam", "Gleam on BEAM", CorpusFormat::Dockerfile, CorpusTier::Production,
            ...
            CorpusEntry::new("D-099", "vlang-app", "V language application", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-100", "milestone-100-docker", "100th Dockerfile entry - full stack", CorpusFormat::Dockerfile, CorpusTier::Production,
    ...
    fn load_expansion6_makefile(&mut self) {
        let entries = vec![
            CorpusEntry::new("M-101", "nx-monorepo", "Nx monorepo build system", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-102", "poetry-python", "Python Poetry project", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: install"),
            CorpusEntry::new("M-103", "bun-project", "Bun JavaScript runtime", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: install"),
            CorpusEntry::new("M-104", "vagrant-vm", "Vagrant VM management", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: up"),
            CorpusEntry::new("M-105", "bazel-remote-cache", "Bazel with remote cache", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-106", "sphinx-docs", "Sphinx documentation build", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: html"),
            CorpusEntry::new("M-107", "cargo-workspace", "Rust Cargo workspace", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-108", "pnpm-turbo", "pnpm with Turborepo", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: install"),
            CorpusEntry::new("M-109", "docker-compose", "Docker Compose orchestration", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: up"),
            CorpusEntry::new("M-110", "flyctl-deploy", "Fly.io deployment", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: deploy"),
            CorpusEntry::new("M-111", "uv-python", "UV Python package manager", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: install"),
            CorpusEntry::new("M-112", "just-runner", "Just command runner wrapper", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-113", "earthly-ci", "Earthly CI/CD build", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-114", "sqlx-migrations", "SQLx database migrations", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: migrate"),
            CorpusEntry::new("M-115", "cross-compile", "Cross-compilation targets", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: build-linux"),
            CorpusEntry::new("M-116", "k3s-deploy", "K3s lightweight Kubernetes", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: deploy"),
            CorpusEntry::new("M-117", "mdbook-docs", "mdBook documentation", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-118", "goreleaser", "GoReleaser distribution", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: snapshot"),
            CorpusEntry::new("M-119", "trivy-scan", "Trivy security scanner", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: scan-image"),
            CorpusEntry::new("M-120", "skaffold-dev", "Skaffold development", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: dev"),
            CorpusEntry::new("M-121", "ruff-python-lint", "Ruff Python linter", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: lint"),
            CorpusEntry::new("M-122", "act-github", "Act local GitHub Actions", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: ci"),
            CorpusEntry::new("M-123", "sops-secrets", "SOPS secrets management", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: encrypt"),
            CorpusEntry::new("M-124", "typst-docs", "Typst document compiler", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-125", "pixi-conda", "Pixi conda package manager", CorpusFormat::Makefile, CorpusTier::Standard,
    ...
    fn load_expansion6_dockerfile(&mut self) {
        let entries = vec![
            CorpusEntry::new("D-101", "deno-fresh", "Deno Fresh web framework", CorpusFormat::Dockerfile, CorpusTier::Production,
            ...
            CorpusEntry::new("D-102", "bun-elysia", "Bun with Elysia framework", CorpusFormat::Dockerfile, CorpusTier::Standard,
                ...
                "FROM oven/bun:1.0"),
            CorpusEntry::new("D-103", "astro-static", "Astro static site builder", CorpusFormat::Dockerfile, CorpusTier::Production,
                r#"fn main() { from_image_as("node", "20-alpine", "builder"); workdir("/app"); copy("package.json", "."); copy("pnpm-lock.yaml", "."); run(&["corepack enable", "pnpm install --frozen-lockfile"]); copy(".", "."); run(&["pnpm build"]); from_image("nginx", "1.25-alpine"); copy_from("builder", "/app/dist", "/usr/share/nginx/html"); expose(80u16); } fn from_image_as(i: &str, t: &str, a: &str) {} fn from_image(i: &str, t: &str) {} fn workdir(p: &str) {} fn copy(s: &str, d: &str) {} fn run(c: &[&str]) {} fn copy_from(f: &str, s: &str, d: &str) {} fn expose(p: u16) {}"#,
                "FROM node:20-alpine AS builder"),
            CorpusEntry::new("D-104", "temporal-worker", "Temporal workflow worker", CorpusFormat::Dockerfile, CorpusTier::Production,
            ...
            CorpusEntry::new("D-105", "dragonfly-cache", "DragonflyDB cache server", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-106", "minio-storage", "MinIO object storage", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-107", "nats-messaging", "NATS messaging server", CorpusFormat::Dockerfile, CorpusTier::Standard,
                ...
                "FROM nats:2.10-alpine"),
            CorpusEntry::new("D-108", "clickhouse-olap", "ClickHouse OLAP database", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-109", "grafana-dashboard", "Grafana monitoring dashboard", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-110", "prometheus-monitoring", "Prometheus monitoring", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-111", "loki-logging", "Grafana Loki logging", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-112", "jaeger-tracing", "Jaeger distributed tracing", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-113", "keycloak-auth", "Keycloak identity server", CorpusFormat::Dockerfile, CorpusTier::Production,
                ...
                "FROM quay.io/keycloak/keycloak:23.0"),
            CorpusEntry::new("D-114", "vault-secrets", "HashiCorp Vault secrets", CorpusFormat::Dockerfile, CorpusTier::Production,
            ...
            CorpusEntry::new("D-115", "consul-service-mesh", "HashiCorp Consul", CorpusFormat::Dockerfile, CorpusTier::Standard,
                ...
                "FROM hashicorp/consul:1.17"),
            CorpusEntry::new("D-116", "etcd-cluster", "etcd key-value store", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-117", "cockroachdb", "CockroachDB distributed SQL", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-118", "scylladb", "ScyllaDB NoSQL database", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-119", "questdb-timeseries", "QuestDB time-series", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-120", "surrealdb", "SurrealDB multi-model database", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-121", "turborepo-build", "Turborepo monorepo build", CorpusFormat::Dockerfile, CorpusTier::Production,
                ...
                "FROM node:20-alpine AS builder"),
            CorpusEntry::new("D-122", "caddy-proxy", "Caddy reverse proxy", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-123", "traefik-ingress", "Traefik ingress controller", CorpusFormat::Dockerfile, CorpusTier::Standard,
                ...
                "FROM traefik:v3.0"),
            CorpusEntry::new("D-124", "envoy-proxy", "Envoy service proxy", CorpusFormat::Dockerfile, CorpusTier::Production,
            ...
            CorpusEntry::new("D-125", "kong-gateway", "Kong API gateway", CorpusFormat::Dockerfile, CorpusTier::Production,
    ...
    fn load_expansion7_makefile(&mut self) {
        let entries = vec![
            CorpusEntry::new("M-126", "cargo-mutants", "Mutation testing with cargo-mutants", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: mutants"),
            CorpusEntry::new("M-127", "cargo-llvm-cov", "Coverage with llvm-cov", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: coverage"),
            CorpusEntry::new("M-128", "semver-release", "Semantic version release", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: bump-patch"),
            CorpusEntry::new("M-129", "pre-commit-hooks", "Pre-commit hook management", CorpusFormat::Makefile, CorpusTier::Standard,
                r#"fn main() { phony_target("hooks-install", &[], &["pre-commit install"]); phony_target("hooks-run", &[], &["pre-commit run --all-files"]); phony_target("hooks-update", &[], &["pre-commit autoupdate"]); } fn phony_target(n: &str, d: &[&str], r: &[&str]) {}"#,
                ".PHONY: hooks-install"),
            CorpusEntry::new("M-130", "mise-polyglot", "Mise polyglot tool manager", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: setup"),
            CorpusEntry::new("M-131", "k6-load-test", "k6 load testing", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: load-test"),
            CorpusEntry::new("M-132", "shellcheck-lint", "ShellCheck script linting", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: lint-sh"),
            CorpusEntry::new("M-133", "cosign-sign", "Cosign container signing", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: sign"),
            CorpusEntry::new("M-134", "depot-build", "Depot accelerated Docker builds", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-135", "pkl-config", "Pkl configuration language", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: eval"),
            CorpusEntry::new("M-136", "sqlfluff-lint", "SQLFluff SQL linter", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: lint-sql"),
            CorpusEntry::new("M-137", "oxlint-fast", "OxLint fast JavaScript linter", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: lint-js"),
            CorpusEntry::new("M-138", "cdk-infra", "AWS CDK infrastructure", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: synth"),
            CorpusEntry::new("M-139", "trunk-wasm", "Trunk WASM bundler", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: serve"),
            CorpusEntry::new("M-140", "ollama-models", "Ollama model management", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: pull"),
            CorpusEntry::new("M-141", "biome-format", "Biome JavaScript formatter", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: format"),
            CorpusEntry::new("M-142", "pkl-codegen", "Pkl code generation", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: codegen"),
            CorpusEntry::new("M-143", "task-runner", "Task runner wrapper", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-144", "atmos-infra", "Atmos infrastructure", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: plan"),
            CorpusEntry::new("M-145", "vale-prose", "Vale prose linter", CorpusFormat::Makefile, CorpusTier::Standard,
                r#"fn main() { let vale = "vale"; phony_target("lint-docs", &[], &["$(VALE) docs/"]); phony_target("sync", &[], &["$(VALE) sync"]); } fn phony_target(n: &str, d: &[&str], r: &[&str]) {}"#,
                ".PHONY: lint-docs"),
            CorpusEntry::new("M-146", "cue-validate", "CUE configuration validation", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: validate"),
            CorpusEntry::new("M-147", "dagger-ci", "Dagger CI pipelines", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: ci"),
            CorpusEntry::new("M-148", "buildpacks", "Cloud Native Buildpacks", CorpusFormat::Makefile, CorpusTier::Standard,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-149", "kustomize-k8s", "Kustomize Kubernetes", CorpusFormat::Makefile, CorpusTier::Production,
                ...
                ".PHONY: build"),
            CorpusEntry::new("M-150", "milestone-150-make", "150th Makefile - DevSecOps pipeline", CorpusFormat::Makefile, CorpusTier::Production,
    ...
    fn load_expansion7_dockerfile(&mut self) {
        let entries = vec![
            CorpusEntry::new("D-126", "apisix-gateway", "APISIX API gateway", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-127", "benthos-stream", "Benthos stream processor", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-128", "zitadel-iam", "Zitadel IAM system", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-129", "tigerbeetle-db", "TigerBeetle financial database", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-130", "redpanda-kafka", "Redpanda Kafka-compatible streaming", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-131", "materialize-streaming", "Materialize streaming SQL", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-132", "duckdb-analytics", "DuckDB analytics container", CorpusFormat::Dockerfile, CorpusTier::Production,
                ...
                "FROM python:3.12-slim"),
            CorpusEntry::new("D-133", "weaviate-vector-db", "Weaviate vector database", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-134", "qdrant-vector-db", "Qdrant vector database", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-135", "chromadb-embeddings", "ChromaDB embedding database", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-136", "langfuse-llm-obs", "Langfuse LLM observability", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-137", "litellm-proxy", "LiteLLM proxy server", CorpusFormat::Dockerfile, CorpusTier::Production,
            ...
            CorpusEntry::new("D-138", "ollama-server", "Ollama LLM server", CorpusFormat::Dockerfile, CorpusTier::Standard,
                r#"fn main() { from_image("ollama/ollama", "0.1"); expose(11434u16); } fn from_image(i: &str, t: &str) {} fn expose(p: u16) {}"#,
                "FROM ollama/ollama:0.1"),
            CorpusEntry::new("D-139", "vllm-inference", "vLLM inference server", CorpusFormat::Dockerfile, CorpusTier::Production,
            ...
            CorpusEntry::new("D-140", "immich-photos", "Immich photo management", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-141", "authentik-sso", "Authentik SSO", CorpusFormat::Dockerfile, CorpusTier::Production,
            ...
            CorpusEntry::new("D-142", "netbird-vpn", "NetBird VPN mesh", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-143", "uptime-kuma", "Uptime Kuma monitoring", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-144", "plausible-analytics", "Plausible web analytics", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-145", "appwrite-backend", "Appwrite backend-as-a-service", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-146", "nocodb-airtable", "NocoDB Airtable alternative", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-147", "n8n-workflow", "n8n workflow automation", CorpusFormat::Dockerfile, CorpusTier::Standard,
                r#"fn main() { from_image("n8nio/n8n", "1.25"); expose(5678u16); } fn from_image(i: &str, t: &str) {} fn expose(p: u16) {}"#,
                "FROM n8nio/n8n:1.25"),
            CorpusEntry::new("D-148", "windmill-workflow", "Windmill workflow engine", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-149", "infisical-secrets", "Infisical secrets management", CorpusFormat::Dockerfile, CorpusTier::Standard,
            ...
            CorpusEntry::new("D-150", "milestone-150-docker", "150th Dockerfile - production Rust service", CorpusFormat::Dockerfile, CorpusTier::Production,
