...
fn explain_why(code: &str) -> String {
    match code {
        ...
        "SEC010" => "Externally-influenced paths in file operations let an attacker escape the intended directory with '..' or an absolute path.",
...
fn explain_fix(code: &str) -> String {
    match code {
        ...
        "SEC010" => "Reject paths containing '..' or a leading '/' before use, or canonicalize with realpath and check the result stays under the intended root.",
