...
fn corpus_history_chart() -> Result<()> {
    use crate::cli::color::*;
...
fn history_chart_cell(score: f64, row: usize, min_score: f64, range: f64, height: usize) {
    use crate::cli::color::*;
    if score <= 0.0 {
        print!(" ");
    } else {
...
/// Detect potentially flaky entries (high timing variance across runs).
fn corpus_flaky(threshold: f64) -> Result<()> {
    use crate::cli::color::*;
    use crate::corpus::registry::CorpusRegistry;
    use crate::corpus::runner::CorpusRunner;
    use std::time::Instant;
...
fn result_dim_pass(r: &crate::corpus::runner::CorpusResult, dim_idx: usize) -> bool {
    match dim_idx {
        0 => r.transpiled,
        1 => r.output_contains,
        2 => r.output_exact,
...
fn corpus_lint_pipeline() -> Result<()> {
    use crate::cli::color::*;
...
fn corpus_regression_check() -> Result<()> {
    use crate::cli::color::*;
    use crate::corpus::citl;
    use crate::corpus::registry::CorpusRegistry;
    use crate::corpus::runner::CorpusRunner;
...
fn corpus_convergence_check() -> Result<()> {
    use crate::cli::color::*;
    use crate::corpus::citl;
    use crate::corpus::registry::CorpusRegistry;
    use crate::corpus::runner::CorpusRunner;
