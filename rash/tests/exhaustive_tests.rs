...
fn test_real_world_edge_cases() {
    ...
    let many_vars = "fn main() { ".to_string() + &"let x = 1; ".repeat(10000) + " }";
    let deep_nesting = "fn main() { let x = ".to_string() + &"(".repeat(1000) + "42" + &")".repeat(1000) + "; }";
    ...
    let test_cases = vec![
        ...
        (deep_nesting.as_str(), false), // Deep nesting
    ];
